...
pygame.display.set_caption("ಭುಕ್ಕಡ್ ಹಾವು")            # setting title of a screen as caption 
    ...
    while not exit_game:
        ...
        if game_over:
            ...
            if abs(snake_x - food_x)<20 and abs(snake_y - food_y)<20:       # sensitivity to take the point ofthe soze
                ...
                food_y = random.randint(60, 600 - 50)
                snk_length +=5                                             # setting the size increament of snake
